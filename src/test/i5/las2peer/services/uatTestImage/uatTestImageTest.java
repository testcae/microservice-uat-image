...
/**
 *
 * uat-image - Test Class
 *
 * This class provides a basic testing framework for the microservice uat-image. It was
...
public class uatTestImageTest {
  ...
  public void testpostImage() {
    ...
    c.setAddressPort(HTTP_ADDRESS, HTTP_PORT);
    try {
      JSONObject postImagePayload = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("POST", mainPath + "/post", postImagePayload.toJSONString(),
